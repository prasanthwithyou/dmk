...
<!-- Mirrored from foxythemes.net/preview/products/amaretti-v1.1.7/pages-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jul 2016 21:13:18 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body class="am-splash-screen">
    <div class="am-wrapper am-login">
         ...
         <div class="login-container">
            <div class="panel panel-default">
              <div class="panel-heading"><img src="../assets/img/logo-full-retina.png" alt="logo" width="75px" height="75px" class="logo-img"></div>
                  ...
                  <div class="login-form">
                    <div class="form-group">
                      <div class="input-group"><span class="input-group-addon"><i class="icon s7-user"></i></span>
                        <input id="username" type="text" placeholder="Username" name="Username" id="Username" autocomplete="off" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group"><span class="input-group-addon"><i class="icon s7-lock"></i></span>
                        <input id="password" type="password" placeholder="Password" name="Password" id="Password"  class="form-control">
                      </div>
                    </div>
                    <div class="form-group login-submit">
                      <button type="button" id="Login"  value="Login" name="Login" class="btn btn-primary btn-lg" onclick="submitForm()">Login</button>
                    </div>
	...
	function submitForm(){
	  $.ajax({
		type:"GET",
		url:'action.php',
		data:$('#LoginForm').serialize() + "&type=LoginForm",
